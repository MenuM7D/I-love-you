...
blackhole.addEventListener('click', () => {
  ...
  // تصميم النافذة المنبثقة لتعرض النص بالكامل
  ...
  loveMessage.style.maxWidth = "90%"; // العرض الأقصى 90% من الشاشة
  loveMessage.style.height = "auto"; // السماح للنص بالتمدد
  ...
  loveMessage.style.top = "50%"; // توسيط النافذة عموديًا
  loveMessage.style.left = "50%"; // توسيط النافذة أفقيًا
  loveMessage.style.transform = "translate(-50%, -50%)"; // تأكيد التوسيط بشكل كامل
